 ...
 *
 * Generation date: 2014/07/10 04:53:51
 */
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            IF EXISTS (
                SELECT * 
                FROM sysobjects 
                WHERE name = 'UNIQ_8C229ACDA96EF72D'
            ) 
            ALTER TABLE claro_mooc_access_constraints 
            DROP CONSTRAINT UNIQ_8C229ACDA96EF72D ELSE 
            DROP INDEX UNIQ_8C229ACDA96EF72D ON claro_mooc_access_constraints
        ");
        $this->addSql("
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("
            IF EXISTS (
                SELECT * 
                FROM sysobjects 
                WHERE name = 'IDX_8C229ACDA96EF72D'
            ) 
            ALTER TABLE claro_mooc_access_constraints 
            DROP CONSTRAINT IDX_8C229ACDA96EF72D ELSE 
            DROP INDEX IDX_8C229ACDA96EF72D ON claro_mooc_access_constraints
        ");
        $this->addSql("
