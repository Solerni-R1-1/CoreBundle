...
class Version20141112113201 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            ...
            doer_ip, 
            tool_name, 
            is_displayed_in_admin, 
            is_displayed_in_workspace, 
            resourceNode_id, 
            doer_session_id 
            FROM claro_log
        ");
        ...
        $this->addSql("
            INSERT INTO claro_log (
                ...
                receiver_id, role_id, \"action\", date_log, 
                short_date_log, details, doer_type, 
                doer_ip, tool_name, is_displayed_in_admin, 
                is_displayed_in_workspace, resourceNode_id, 
                doer_session_id
            ) 
            SELECT id, 
            doer_id, 
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("
            INSERT INTO claro_log (
                ...
                details, doer_type, doer_ip, doer_session_id, 
                tool_name, is_displayed_in_admin, 
                is_displayed_in_workspace, resourceNode_id
            ) 
            SELECT id, 
            doer_id, 
