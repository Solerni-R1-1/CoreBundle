...
class MoocType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('notifarticlemooc', 'checkbox',  array('label' => 'Envoyer notification article', 'required' => false))
            ->add('notifsujetthememooc', 'checkbox',  array('label' => 'Envoyer notification thème', 'required' => false))
            ->add('notifcitermooc', 'checkbox',  array('label' => 'Envoyer notification citation', 'required' => false))
            ->add('notiflikemooc', 'checkbox',  array('label' => 'Envoyer notification like', 'required' => false))
